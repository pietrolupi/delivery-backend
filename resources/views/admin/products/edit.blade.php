...
@section('content')
    ...
    <form class="form-group mb-2" action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <p>Old image:</p>
        <img id="thumb" src="{{ asset('storage/' . $product->image) }}" alt="{{$product->name}}" class="w-25">
    </div>
