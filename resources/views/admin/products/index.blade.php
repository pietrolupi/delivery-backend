    ...
    <div class="d-flex flex-wrap gap-3 flex-column flex-md-row align-items-center mt-4">
        ...
        @foreach ($products as $product)
            ...
            <a href="{{ route('admin.products.show', $product)}}" >
                ...
                <div class="card product d-flex p-2 flex-column align-items-center justify-content-center {{ $product->visibility == 0 ? 'unavaliable' : '' }}" style="width: 15rem;" >
                    <div class="image">
                        <img src="{{ asset('storage/' . $product->image) }}" onerror="this.src='{{ asset('img/placeholder.jpg') }}'" class="img-fluid card-img-top w-100 h-100 object-fit-cover" alt="{{ $product->name}}">
                    </div>
                    <div class="card-body">
